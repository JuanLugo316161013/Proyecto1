...
public class GraficadoraSVG<T extends DatoGraficable<T>>{
	...
	public static void main(String[] args) {
		...
		palabras[1] = new Palabra("preciosa 7u7",10);
		palabras[2] = new Palabra("cuando",7);
		palabras[3] = new Palabra("sales por",18);
		palabras[4] = new Palabra("el pan 7u7",9);
		GraficadoraSVG<Palabra> g = new GraficadoraSVG<Palabra>(palabras,100); 
		System.out.println(g.graficaBarras());
	}
}