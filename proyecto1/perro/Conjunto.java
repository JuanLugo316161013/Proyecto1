...
public class Conjunto<T> implements Coleccion<T> {
    ...
    public Conjunto<T> union(Conjunto<T> conjunto) {
        // Aquí va su código.
        Conjunto<T> union = new Conjunto<T>(this.conjunto.getElementos() + conjunto.getElementos());
    ...
    @Override public String toString() {
        // Aquí va su código.
        int elementos = this.conjunto.getElementos();
    ...
    @Override public boolean equals(Object o) {
        if (o == null || getClass() != o.getClass())
            return false;
        @SuppressWarnings("unchecked") Conjunto<T> conjunto = (Conjunto<T>)o;
        // Aquí va su código.
        if (conjunto.getElementos() != this.conjunto.getElementos())
            return false;
